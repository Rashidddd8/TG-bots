...
def func(message):
    if (message.text == "Для работы"):
        ...
        bot.send_message(message.chat.id, text="Цена - 1200 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 1000 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 1600 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 1500 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 800 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 1800 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 3000 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 700 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 3500 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 2500 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - 2100 рублей")
        ...
        back = types.KeyboardButton("Вернуться в главное меню")
        markup.add(btn0, back)
        bot.send_message(message.chat.id, text="Цена - от 2500 рублей")
        ...
        bot.send_photo(message.chat.id, p)
        bot.send_message(message.chat.id, text="Цена - от 1200 рублей")
